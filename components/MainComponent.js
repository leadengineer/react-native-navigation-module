...
export default class MainComponent extends Component {
    static navigationOptions = ({ navigation }) => {
        ...
        let headerRight = (<Button
            containerStyle={{ margin: 5, padding: 10, borderRadius: 10, backgroundColor: 'orange' }}
    ...
    render() {
        ...
        let mainView = (navigation.state.params && navigation.state.params.isSaving == true) ? <ActivityIndicator /> :
            <View style={{
                ...
                <Button
                    containerStyle={{ padding: 10, margin: 20, width: 200, height: 45, borderRadius: 10, backgroundColor: 'orange' }}
